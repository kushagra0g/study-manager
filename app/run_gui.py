...
def main():
    ...
    def add_subject_button_handler():
        def handle_add_subject():
            ...
            if subject_name:
                ...
                entry.delete(0, "end")
                CTkLabel(master=task_frame,
                         text=f"New subject added successfully ",
                         text_color="green",
        ...
        CTkButton(master=task_frame,
                  ...
                  font=("Bahnschrift", 17),
                  fg_color="#000814",
                  command=handle_add_subject).pack(padx=20, pady=20)

    def add_task_button_handler():
        # to develop
        ...
    app = CTk(fg_color="#000814")
    ...
    subject_frame = CTkScrollableFrame(master=app,
                                       fg_color="#001D3D",
                                       scrollbar_button_color="#000814",
                                       scrollbar_button_hover_color="#003566"
                                       )
